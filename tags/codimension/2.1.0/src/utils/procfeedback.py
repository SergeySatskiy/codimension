...
#
# $Id: procfeedback.py 810 2012-09-18 03:24:05Z dmitrykazimirov@gmail.com $
#
...
def sendFeedbackMessage( localPort, parts ):
    ...
    sock.sendto( msg, ( '127.0.0.1', localPort ) )
    return
...
if __name__ == '__main__':
    ...
    try:
        ...
        print >> sys.stderr, "Cannot get port number"
        sys.exit( 2 )

    try:
        sendFeedbackMessage( port, sys.argv[ 2: ] )
    except:
        print >> sys.stderr, "Cannot send feedback message"
        sys.exit( 3 )
