...
import os.path
from ui.qt import QPixmap, QColor
...
( IND_MODIFIED_LR,
  ...
  None, QColor( 220, 255, 220, 255 ),
  "Modified locally and in SVN repository (content and/or properties)" ),
( IND_MODIFIED_L,
  QPixmap( pluginHomeDir + "status-locally-modified.png" ),
  None, QColor( 220, 255, 220, 255 ),
  "Modified locally (content and/or properties)" ),
( IND_MODIFIED_R,
  QPixmap( pluginHomeDir + "status-repos-modified.png" ),
  None, QColor( 220, 255, 220, 255 ),
  "SVN repository version updated (content and/or properties)" ),
( IND_UPTODATE,
